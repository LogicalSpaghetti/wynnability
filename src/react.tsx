    ...
    return <>
        <section className="mt-2 pb-2 pt-2">
            <div className="d-flex justify-content-start align-items-center ps-1 pe-1">
                <button type="button" className="btn btn-primary me-auto" data-bs-toggle="collapse"
                        data-bs-target="#extraSettings"
                ...
                <button type="button" className="btn btn-primary ms-1 me-2" data-bs-toggle="modal"
            ...
            <div className="collapse" id="extraSettings">
                <form>
                    ...
                    <div className="row">
                        <div
                            className="col-xs-12 col-sm-6 col-lg-3 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div className="col-xs-12 col-sm-6 col-lg-3 pt-3 d-flex flex-column align-items-center">
                            <div className="d-flex flex-row ps-3 align-items-center justify-content-between"
                                 style={{width: "85%"}}>
                                <div className="me-5 text-light"><label htmlFor="maxAbilityPoints"
                                                                        className="form-label">Ability
                                    Points</label></div>
                            ...
                            <div className="d-flex flex-row pt-3 ps-3 align-items-center justify-content-between"
                                 style={{width: "85%"}}>
                                <div className="me-5 text-light"><label htmlFor="treePages" className="form-label">Vertical
                                    Pages</label>
                                </div>
                                <div><input type="number" className="form-control integer settingNumberInput"
                                            id="treePages"
                            ...
                            <div className="d-flex flex-row pt-3 ps-3 align-items-center justify-content-between"
                                 style={{width: "85%"}}>
                                <div className="me-5 text-light"><label htmlFor="horizontalPages"
                                                                        className="form-label">Horizontal
                                    Pages</label></div>
                                <div><input type="number" className="form-control integer settingNumberInput"
                                            id="horizontalPages"
                        ...
                        <div className="col-xs-12 col-sm-6 col-lg-3 pt-3 d-flex flex-column align-items-center">
                            <div className="d-flex flex-row ps-3 align-items-center justify-content-between"
                                 style={{width: "85%"}}>
                                <div className="me-5 text-light"><label htmlFor="rowsPerPage" className="form-label">Rows
                                    Per Page</label>
                                </div>
                                <div><input type="number" className="form-control integer settingNumberInput"
                                            id="rowsPerPage"
                            ...
                            <div className="d-flex flex-row pt-3 ps-3 align-items-center justify-content-between"
                                 style={{width: "85%"}}>
                                <div className="me-5 text-light"><label htmlFor="startingPage" className="form-label">Starting
                                    Page</label>
                                </div>
                                <div><input type="number" className="form-control integer settingNumberInput"
                                            id="startingPage"
                        ...
                        <div className="col-xs-12 col-sm-6 col-lg-3 pt-4 d-flex flex-column align-items-center">
                            <div
                                className="d-flex flex-row ps-3 align-items-center justify-content-between form-check form-switch"
                                style={{width: "85%"}} title="Whether left and right borders can connect">
                                <label className="form-check-label text-light" htmlFor="loopTreeSwitch">Loop
                                    tree</label>
                            ...
                            <div
                                ...
                                <label className="form-check-label text-light" htmlFor="travelUpSwitch">Travel
                                    Up</label>
                                <input className="form-check-input me-4" type="checkbox" role="switch"
                                       id="travelUpSwitch"
                                       onInput={() => oldTree.readProperties()}/>
                            ...
                            <div
                                ...
                                <label className="form-check-label text-light" htmlFor="altIconSwitch">Extra Ability
                                    Icons</label>
                                <input className="form-check-input me-4" type="checkbox" role="switch"
                                       id="altIconSwitch"
                                       onInput={() => oldTree.readProperties()}/>
            ...
            <div className="row justify-content-center ms-2 me-2">
                <div className="col-xs-12 col-sm-12 col-md-6 p-0" style={{maxWidth: "500px"}}>
                    ...
                    <div className="w-100 h-auto"
                         style={{
                             aspectRatio: "406 / 44",
                             backgroundImage: "url(assets/img/background/tree_top.png)",
                    ...
                    <div className="w-100 h-auto d-flex flex-row"
                         style={{
                             backgroundImage: "url(assets/img/background/tree_scroll.png)",
                    ...
                    <div className="w-100 h-auto"
                         style={{
                             aspectRatio: "406 / 44",
                             backgroundImage: "url(assets/img/background/tree_bot.png)",
                             backgroundRepeat: "no-repeat",
                             backgroundSize: "100% auto",
                         }}>
                    </div>
                ...
                <div className="d-flex flex-column col-xs-12 col-sm-12 col-md-5 col-lg-5 ms-md-4 p-0"
                            ...
                            <div className="d-flex justify-content-end align-items-center ps-2 pe-2 mt-2">
                                ...
                                <div className="me-auto ms-2">
                                    ...
                                    <label className="btn btn-outline-success" style={{height: "25px", width: "25px"}}
                                           ...
                                           title="Filter abilities that are not on the tree"><span
                                        style={{
                                            position: "relative",
                                            top: "-18px",
                                            left: "-13.5px",
                    ...
                    <div className="shown-on-allocation mt-2 normal-container">
                        <div className="m-2 mb-1 overflow-auto" style={{maxHeight: "204px"}}
                             id="archetypeCountContainer"></div>
                    </div>
                    <div className="flex-grow-1 position-relative mt-2 mb-2 shown-on-allocation"
                         style={{minHeight: "400px"}}>
                        <div className="position-absolute normal-container"
                             style={{left: 0, top: 0, width: "100%", height: "100%"}}>
                            <div className="d-flex justify-content-between align-items-center ps-2 pe-2 mt-2">
                                <div className="minecraftTooltip pt-2 overflow-hidden col"
        ...
        <section className="mt-2 d-flex p-3 justify-content-center">
            <div className="text-light d-flex flex-column justify-content-between align-items-center"
                 style={{width: "100px"}}>
                ...
                <div className="mt-5 mb-2 d-flex flex-column align-items-center">
                    <div className="text-light"><label htmlFor="maxSaveStates" className="form-label">Record
                        last</label></div>
                    <div><input type="number" value="10" className="form-control integer" style={{width: "80px"}}
                                id="maxSaveStates"/>
                    </div>
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header text-light" data-bs-theme="dark">
                        <h1 className="modal-title fs-5 overflow-hidden text-nowrap" id="exampleModalLabel">Load a
                            custom tree</h1>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                        <div id="loadinterface">
                            <input type="text" id="json-container"
                                   className="overflow-hidden generic-background text-light"
                        ...
                        <div id="libraryinterface" hidden>
                            ...
                            <div className="d-flex mt-2 mb-2">
                                <select className="form-select form-select-sm me-3" aria-label="Class filter"
        ...
        <div className="modal fade modal-lg" id="abilityModal" tabIndex={-1} aria-labelledby="Ability Edit"
             aria-hidden="true"
                        ...
                        <textarea style={{minHeight: "200px"}} className="form-control focusable"
                            ...
                            <div className="d-flex align-items-center justify-content-between w-100 mt-2 ps-1">
                                <div className="me-5 text-light"><label htmlFor="archetypePointsRequiredInput"
                                                                        className="form-label">Archetype
            ...
            <div className="modal-dialog modal-dialog-centered"
                ...
                <div className="modal-content">
                    <form>
                        ...
                        <div className="modal-header justify-content-end">
                            ...
                            <div>
                                ...
                                <div className="row justify-content-end mt-2" style={{textAlign: "end"}}>
                                    ...
                                    <button type="button"
                                            className="btn btn-secondary me-3 text-decoration-line-through medium-btn"
                                            title="Strikethrough"
                                            onClick={() => insertStringBeforeSelected(`${preferredDelimiter}m`)}>S
                                    </button>
                        ...
                        <div className="modal-body">
                            <div className="form-floating">
                                <input type="text" className="form-control focusable" id="treeNameInput"
                                       autoComplete="off"
                                       placeholder="ex. Mango Tree"
                                       onInput={(e) => convertToMinecraftTooltip(e.currentTarget.value, 'treeTooltip')}
                                       maxLength={100}/>
        ...
        <div className="toast-container position-fixed bottom-0 end-0 p-3">
            <div className="toast align-items-center" id="smallToast" role="alert" aria-live="assertive"
                 aria-atomic="true">
